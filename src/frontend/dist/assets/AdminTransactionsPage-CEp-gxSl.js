import { c as createLucideIcon, s as createContextScope, t as React2, v as useComposedRefs, j as jsxRuntimeExports, w as createSlot, r as reactExports, x as reactDomExports, y as Primitive, z as useLayoutEffect2, A as useCallbackRef, D as useControllableState, F as useId, H as composeEventHandlers, I as Portal$1, J as hideOthers, K as useFocusGuards, M as ReactRemoveScroll, N as FocusScope, Q as DismissableLayer, q as cn, U as Presence } from "./index-61-h5hTH.js";
import { S as Skeleton } from "./skeleton-j03Je6rt.js";
import { S as StatusBadge } from "./StatusBadge-D6wmLnVx.js";
import { k as useAllTransactions } from "./useAdmin-Bwe8enWW.js";
...
function TxRowSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-border", children: ["c1", "c2", "c3", "c4", "c5", "c6"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-20" }) }, id)) });
}
function AdminTransactionsPage() {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return [...transactions].sort((a, b) => b.createdAt - a.createdAt).filter((tx) => typeFilter === "all" || tx.type === typeFilter).filter((tx) => statusFilter === "all" || tx.status === statusFilter);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10 border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "w-6 h-6 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Transaction History" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Full audit log — all users" })
          ] }),
          transactions && transactions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-sm text-muted-foreground", children: [
            "Showing",
            " ",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Tabs,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "bg-muted/40 border border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      TabsTrigger,
                      {
                        value: "all",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", "data-ocid": "admin.transactions.list", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            isLoading && ["r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(TxRowSkeleton, {}, id)),
            isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No transactions found" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-60", children: typeFilter !== "all" || statusFilter !== "all" ? "Try adjusting your filters." : "No transactions have been made yet." })
                ]
              }
            ) }) }),
            filtered.map((tx, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `game-badge text-[10px] px-2 py-0.5 ${tx.type === "deposit" ? "bg-green-900/20 text-green-400 border border-green-700/40" : "bg-orange-900/20 text-orange-400 border border-orange-700/40"}`,
                      children: tx.type === "deposit" ? "Deposit" : "Withdraw"
                    }
                  ) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "td",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "td",
                    {
                      ...
                      title: tx.adminNote ?? "",
                      children: tx.adminNote ? tx.adminNote : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-30", children: "—" })
                    }
                  )
                ]
              },
