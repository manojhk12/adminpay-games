import { r as reactExports, j as jsxRuntimeExports, g as useActor, h as useQuery, l as useQueryClient, e as ue, m as apiRequestDeposit, n as apiRequestWithdrawal, i as createActor, o as apiGetMyTransactions } from "./index-61-h5hTH.js";
...
function useMyTransactions(enabled = true) {
...
function useRequestDeposit() {
  ...
  return useMutation({
    ...
    onError: (e) => ue.error(e.message ?? "Failed to submit deposit")
  });
}
function useRequestWithdrawal() {
  ...
  return useMutation({
    ...
    onError: (e) => ue.error(e.message ?? "Failed to submit withdrawal")
  });
}
export {
  ...
  useRequestDeposit as a,
  useRequestWithdrawal as b,
  useConstant as c,
  usePresence as d,
  useIsomorphicLayoutEffect as e,
  isHTMLElement as i,
  motion as m,
  useMyTransactions as u
};
