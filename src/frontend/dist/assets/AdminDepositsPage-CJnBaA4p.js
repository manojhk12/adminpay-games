import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button } from "./index-61-h5hTH.js";
...
import { b as usePendingDeposits, d as useApproveDeposit, e as useRejectDeposit } from "./useAdmin-Bwe8enWW.js";
...
function ActionDialog({ tx, mode, onClose }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DialogTitle,
          {
            ...
            children: isApprove ? "✓ Approve Deposit" : "✗ Reject Deposit"
          }
        ) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
              {
                ...
                children: isApprove ? "Note (optional)" : "Rejection reason (required)"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isPending ? "Processing…" : isApprove ? "Approve" : "Reject"
            }
          )
        ] })
      ]
...
function ScreenshotDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Payment Screenshot" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg overflow-hidden border border-border bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: url,
            alt: "Payment proof",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-yellow-400/10 border border-yellow-400/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleArrowUp, { className: "w-6 h-6 text-yellow-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Pending Deposits" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Review and approve deposit requests" })
          ] }),
          deposits && deposits.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto game-badge-pending", children: [
            deposits.length,
            " pending"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", "data-ocid": "admin.deposits.list", children: [
            ...
            isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No pending deposits" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-60", children: "All deposit requests have been processed." })
                ]
              }
            ) }) }),
            deposits == null ? void 0 : deposits.map((tx, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right font-bold text-green-400", children: fmt(tx.amount) }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center", children: tx.paymentProofUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs opacity-40", children: "—" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActionDialog, { tx: activeRow, mode: dialogMode, onClose: closeDialog }),
